...
export default function Sidebar({
    ...
    const populateSidebar = useCallback(async () => {
        const [phoneData, categoriesData, scheduleData, shipmentData, certificationsData, paymentsData, videosData] = await Promise.all([
        ...
        return (
            <aside className={"sidebar"}>
                ...
                <section>
                    ...
                    <main>
                        {
                            shipment.length && shipment.map((item) => (
