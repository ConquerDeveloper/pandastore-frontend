...
export async function getStaticProps() {
    ...
    const pageData = await fetch(`${Constants.HOST}/api/cliente?populate[Clientes][populate][0]=carrusel`)
    const {data: {attributes: {Clientes: clientes}}} = await pageData.json();
